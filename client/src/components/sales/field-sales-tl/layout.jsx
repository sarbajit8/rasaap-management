    ...
    <div className="flex h-screen bg-gray-100 overflow-hidden font-sans">
      ...
      >
        ...
        <nav className="px-4 mt-6 space-y-6">
          <Link
            to="/fieldsalestl/dashboard"
            className="flex items-center space-x-4 text-gray-700 hover:text-gray-600 transition-all duration-200 hover:scale-105"
          >
            <LayoutDashboard size={22} />
            <span className="text-lg font-semibold">Dashboard</span>
          </Link>
          <Link
            to="/fieldsalestl/viewdata"
            className="flex items-center space-x-4 text-gray-700 hover:text-gray-600 transition-all duration-200 hover:scale-105"
          >
            <User size={22} />
            <span className="text-lg font-semibold">View Data</span>
          </Link>
          <button
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white w-full shadow-md px-6 py-4 flex items-center justify-between sticky top-0 z-20 border-b-2 border-gray-200">
          <div className="flex items-center space-x-6">
            ...
            <h1 className="text-2xl font-bold text-gray-800">Field Sales Leader Dashboard</h1>
          </div>
        </header>
...
export default FieldLeaderLayout